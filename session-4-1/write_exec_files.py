...
f_v.write("#!/bin/csh\n\n\nset dir = ./test/\n")
f_v.write("set indir = /Users/brownscholar/Documents/\n")
...
f_v.write("set filedh =  {$indir}/Geofiles/Geofiles_"+str(file_number)+".gr\n")
f_v.write("set filest =  {$indir}/Densityfiles/Densityfiles_"+str(file_number)+".gr\n")
